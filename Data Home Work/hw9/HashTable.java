public class HashTable {
    ...
    public int getIndex(String s){
        int index = polyHash(s, this.p, this.x) % capacity; // Hash and Cardinality Fix
        if(arr[index] == null) return index; // 2.
        if(arr[index] == s) return index; // 3.
         // Quadratic Probing
    ...
    public static int polyHash(String s, int p, int x){ //Polynomial Hashing
        int hash = 0;
        // Do something
